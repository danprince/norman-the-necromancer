...
//level 10(mob crazy)
  ...
  12, BANDIT, 2, RAGE_KNIGHT, 7, ARCHER, END_OF_WAVE,
  3, WIZARD, 6, SHELL_KNIGHT, 9, MONK, END_OF_WAVE,
  8, ROYAL_GUARD, 5, CHAMPION, 5, RAGE_KNIGHT, 4, WIZARD, 4, ARCHER, END_OF_LEVEL,
  1, THE_KING, END_OF_LEVEL


  // Level 11 - The King (Boss Fight)
  1, THE_KING, END_OF_LEVEL,
];
